...
const CATALOG = [
  ...
  // ── LEAD POOL (Free Pool) ─────────────────────────────
  { key: 'pool.view',           label: 'Lead Pool — View pool + available counts' },
  { key: 'pool.pull',           label: 'Lead Pool — Pull leads from pool' },
  // ── COMPLIANCE ──────────────────────────────────────────────────────
