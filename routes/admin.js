...
const CONFIG_KEYS = [
  ...
  // DIRECTION_SETS_v1 — company defaults for the two checkbox groups.
  'CALLS_SYNC_DIRECTIONS', 'CALLS_AUTOLEAD_DIRECTIONS',
  'COMPANY_NAME', 'COMPANY_LOGO_URL', 'COMPANY_GST', 'COMPANY_ADDRESS', 'COMPANY_PHONE', 'COMPANY_EMAIL',
  'PHONE_91_PREFIX_ENABLED', /* PHONE_91_PREFIX_v1 */
  ...
  // LEAD_POOL_v1 — "Free Pool" / status-released lead pool.
  ...
  'POOL_ENABLED', 'POOL_STATUS_IDS', 'POOL_PULL_USER_IDS', 'POOL_PULL_RULES',
  ...
  'WB_CHAT_V2_ENABLED', 'WA_CATALOGUE_ENABLED',      // WB_CHAT_v2 — redesigned 3-column WhatsApp chat (vserve beta)
